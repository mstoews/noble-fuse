...
import { AcccountsPayableLedger} from 'app/models';
...
export class AccountPayableLedgerComponent implements OnInit{
    // Inject the modules
    private accountsPayableService = inject(AccountsPayableLedgerService);
