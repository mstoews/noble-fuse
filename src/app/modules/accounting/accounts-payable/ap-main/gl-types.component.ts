...
import { AccountType } from 'app/modules/models';
...
@Component({
  ...
  imports: [CommonModule, DxDataGridModule, DxBulletModule, DxTemplateModule, MatSidenavModule, MatCardModule,  ReactiveFormsModule,
